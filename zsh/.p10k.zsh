# Generated by Powerlevel10k configuration wizard on 2023-10-08 at 15:55 EEST.
...
# disconnected, no frame, sparse, many icons, fluent, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#74c7ec'
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#94e2d5'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%120F'  # green foreground
      local   modified='%229F'  # yellow foreground
      local  untracked='%159F'  # blue foreground
      local conflicted='%210F'  # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%60F'   # grey foreground
      local      clean='%60F'   # grey foreground
      local   modified='%60F'   # grey foreground
      local  untracked='%60F'   # grey foreground
      local conflicted='%60F'   # grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND='#94e2d5'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND=210
  ...
  #######################[ direnv: direnv status (https://direnv.net/) ]########################
  # Direnv color.
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND='#f2cdcd'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND='#74c7ec'
